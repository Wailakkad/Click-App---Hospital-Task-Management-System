...
export default function ReceptionTasksPage() {
  ...
  const EmptyState = () => (
    <div className="flex flex-col items-center justify-center py-16">
      ...
      <p className="text-slate-500 text-center max-w-md">You're all caught up! New administrative tasks will appear here when they're assigned to you.</p>
    </div>
  );
        ...
        <div className="p-6 border-b border-slate-200">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-slate-500 truncate">{user?.email || 'reception@hospital.com'}</p>
            </div>
          </div>
        </div>
        ...
        <nav className="p-6">
          <ul className="space-y-2">
            ...
            <li>
              <a className="flex items-center space-x-3 text-slate-600 hover:text-blue-600 hover:bg-blue-50 px-3 py-2 rounded-lg transition-colors cursor-pointer">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0V6a2 2 0 012-2h4a2 2 0 012 2v1M8 7h8m-8 0H7a2 2 0 00-2 2v10a2 2 0 002 2h1M8 7v10a2 2 0 002 2h1m7-19v4m-7 6h7m0 0v6a2 2 0 01-2 2h-1" />
                </svg>
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center space-x-3 mb-2">
                <h1 className="text-2xl font-bold text-slate-900">My Administrative Tasks</h1>
                <div className="px-2 py-1 bg-blue-100 text-blue-700 rounded-md text-xs font-medium">
                  {user?.role?.toUpperCase() || 'RECEPTION'}
                </div>
              </div>
              <p className="text-slate-600">
                Welcome back, {user?.name || 'Reception Staff'}! Manage your administrative tasks and front desk responsibilities
              </p>
            </div>
